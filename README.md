...
2. 开启树莓派，在系统桌面上打开 LX 终端。
   <p align="center"><img width="40%" src="https://github.com/Microactive/Classify-rubbish-by-voice/blob/master/readme_pictures/terminal.png" /></p>
...
4. 使用键盘“↑↓”键选择图示箭头位置，按回车前往该选项。
   <p align="center"><img width="40%" src="https://github.com/Microactive/Classify-rubbish-by-voice/blob/master/readme_pictures/settings.png" /></p>
   
5. 选择“P5 I2C”功能会将该树莓派的 IIC 服务开启。
   <p align="center"><img width="40%" src="https://github.com/Microactive/Classify-rubbish-by-voice/blob/master/readme_pictures/I2C.png" /></p>
6. 使用“←→”按键选择“Yes”。
   <p align="center"><img width="40%" src="https://github.com/Microactive/Classify-rubbish-by-voice/blob/master/readme_pictures/I2C-yes.png" /></p>
...
10. 通过下方指令可以查看连接至树莓派拓展板上的语音识别模块。
    ...
    ```
    <p align="center"><img width="40%" src="https://github.com/Microactive/Classify-rubbish-by-voice/blob/master/readme_pictures/check.png" /></p>
